...
$root.SdkTranscriptItem = (function() {
     ...
     * @property {string|null} [confidence] SdkTranscriptItem confidence
     ...
     * @instance
     */
    SdkTranscriptItem.prototype.confidence = "";
    ...
    SdkTranscriptItem.encode = function encode(message, writer) {
        ...
        if (message.confidence != null && message.hasOwnProperty("confidence"))
            writer.uint32(/* id 8, wireType 2 =*/66).string(message.confidence);
